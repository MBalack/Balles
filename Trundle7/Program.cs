...
namespace Trundle7
{
    internal class Program
    {
        ...
        private static void KillSteal()
        {
            ...
            foreach (var target in EntityManager.Heroes.Enemies.Where(hero => hero.IsValidTarget(600) && !hero.HasBuff("JudicatorIntervention") && !hero.HasBuff("kindredrnodeathbuff") && !hero.HasBuff("Undying Rage") && !hero.IsDead && !hero.IsZombie && (hero.HealthPercent <= 25)))
            {
